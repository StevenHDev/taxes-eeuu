...
/**
 * El texto compilado por PromptActivoStepsSeeder (config) DEBE reproducir
 * exactamente la lista ACTIVOS que antes vivía fija en
 * prompt_actuales/fases/recoleccion.md — para que sacarla a config no
 * cambie el comportamiento del agente al publicarla. La salvaguarda sí
 * cambia deliberadamente: antes solo cubría Empleo, ahora cubre los 6 pasos.
 */
class ActivosPromptComposerTest extends TestCase
{
    ...
    public function test_compilar_lista_reproduce_exactamente_el_texto_original(): void
    {
        $esperado = <<<'TXT'
